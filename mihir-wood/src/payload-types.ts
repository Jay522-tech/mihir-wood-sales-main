...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "StoreArchiveBlock".
 */
export interface StoreArchiveBlock {
  title?: string | null;
  stores?: (string | Store)[] | null;
  id?: string | null;
  blockName?: string | null;
  blockType: 'storeArchive';
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "StoreArchiveBlock_select".
 */
export interface StoreArchiveBlockSelect<T extends boolean = true> {
  title?: T;
  stores?: T;
  id?: T;
  blockName?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CategoryCirclesBlock_select".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CustomFurnitureBlock_select".
 */
