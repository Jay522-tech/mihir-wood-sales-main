...
export async function generateMetadata(): Promise<Metadata> {
    const page = await queryPage('terms-and-conditions')
    return {
        title: page?.meta?.title || 'Terms and Conditions | Mihir Wood',
        description: page?.meta?.description || 'Read our terms and conditions for orders, deliveries, and custom furniture services.',
    }
}
