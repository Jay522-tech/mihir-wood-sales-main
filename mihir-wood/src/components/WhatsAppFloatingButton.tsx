...
import { getWhatsAppLink } from '@/utilities/whatsapp'
import { useWhatsApp } from '@/providers/WhatsApp'

export const WhatsAppFloatingButton: React.FC = () => {
    const { phoneNumber, defaultMessage } = useWhatsApp()
    const message = defaultMessage || "Hello, I have an inquiry about your products."

    return (
        <a
            href={getWhatsAppLink(message, phoneNumber)}
            target="_blank"
