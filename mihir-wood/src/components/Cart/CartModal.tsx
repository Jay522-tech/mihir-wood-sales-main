...
import { formatCartMessage, getWhatsAppLink } from '@/utilities/whatsapp'
            ...
            <div className="flex flex-col justify-between w-full">
              ...
              <div className="px-4">
                <div className="py-4 text-sm text-neutral-500 dark:text-neutral-400">
                  ...
                  <Button asChild className="mt-2 w-full bg-green-600 hover:bg-green-700 text-white" variant="secondary">
                    <a
                      href={getWhatsAppLink(formatCartMessage(cart))}
