...
const reviews = [
    {
        ...
        text: 'The teak wood dining table we ordered is a masterpiece. The craftsmanship is impeccable, and it has become the centerpiece of our home. Truly premium quality!',
        rating: 5,
    },
    {
        name: 'Hotel Grand Hyatt',
        location: 'Corporate Project',
        text: 'Mihir Wood truly understands luxury at scale. Our new lounge furniture is stunning, durable, and was delivered right on schedule. Exceptional service.',
        rating: 5,
    },
    {
        name: 'Priya Kapoor',
        location: 'Delhi, India',
        text: 'From wood selection to final installation, the process was seamless. The wardrobe they built is exactly what I envisioned. Highly professional team!',
        rating: 5,
    },
]
...
const CustomerReviews: React.FC = () => {
    return (
        <section className="relative py-16 md:py-20 bg-[#F9F7F2] overflow-hidden">
            ...
            <div className="container relative z-10 px-4">
                <div className="max-w-4xl mx-auto text-center mb-12 space-y-4">
                    ...
                    <h3 className="text-3xl md:text-5xl font-black uppercase tracking-tighter italic leading-none flex flex-col items-center">
                        <span className="text-black mb-1">Real Stories From</span>
                        <span className="text-[#D4BC9B] drop-shadow-sm">Real Homes</span>
                    </h3>
                ...
                <div className="mt-12 text-center">
                    <button className="group relative overflow-hidden bg-black text-white px-8 py-3 rounded-full font-black uppercase tracking-widest text-[10px] transition-all hover:bg-[#D4BC9B] hover:text-black shadow-xl">
